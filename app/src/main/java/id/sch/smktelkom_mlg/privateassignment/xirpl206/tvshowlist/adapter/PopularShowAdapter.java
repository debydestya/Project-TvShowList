...
public class PopularShowAdapter extends RecyclerView.Adapter<PopularShowAdapter.ViewHolder> {
    ArrayList<Result> list;
    ISourceAdapter mISourceAdapter;
    Context context;


    public PopularShowAdapter(Context context, ArrayList<Result> list) {
        this.list = list;
